...
export class OrderService {
  ...
  createOrders(orderPayment: Order, userId: any) {
    return this.http.post(URL + 'create/order' + "?userId=" + userId, orderPayment).map((response: Response) => response.json());
  ...
  getPayments(): Observable<Order[]> {
    ...
    // get users from api
    return this.http.get(URL + 'get/orderAll', options).map((response: Response) => response.json());
  ...
  getPaymentsById(id): Observable<Order[]> {
    ...
    // get users from api
    return this.http.get(URL + 'getOrder/' + id, options).map((response: Response) => response.json());

...
export class StudentService {
  ...
  editContent(id, stStudentId: any, stContent: any, content: Student) {
    return this.http.put(AppComponent.API_URL + 'editContent/' + id + "?stStudentId=" + stStudentId + "&" + "stContent=" + stContent, content).map((response: Response) => response.json());
  }
